...
const Footer = () => {
  ...
  let textArr=[["Sell Phone","Sell Television","Sell Smart Watch","Sell Smart Speakers","Sell DSLR Camera","Sell Earbuds","Repair Phone","Buy Phone","Recycle Phone","Finr New Phone","Partner With Us"],["About us","Careers","Articles","Press Releses","Become cashify Partner","Become supersale partner"],["Mobile Phone","laptop","tablet","imac","gaming consoles"],["FAq","contact us","Warrenty policy","refund policy"],["Terms & conditions","privacy policy","terms of use","e-waste policy","coolie policy","gdpr compliance","what is refurbished","device safty"]]
  return (
    <div className='bg-[#F7F7F7] px-[2vw]'>
        <div className='sm:flex sm:gap-[2.5rem] '>
            
            <div className='sm:flex '>
             
              <div className=' sm:w-[20rem] sm:flex-shrink-0 '>
              ...
              <div className='border-b-2 sm:border-none py-[1rem]'>
                   <p className='text-[#707070] font-bold ml-[.5rem] mb-[1rem]'>Services</p>
                   <ul>
                   {
                    textArr[0].map((item)=>{
                      return <li className=' capitalize text-[#707070] font-medium text-[13px] mt-[10px] ml-[1.1rem]'>{item}</li>
                    })
                   }
                   </ul>
            </div>
            ...
            <p className='text-[#707070] font-bold mb-[1rem] ml-[.5rem]'>Company</p>
                   ...
                   {
                    textArr[1].map((item)=>{
                      return <li className=' capitalize text-[#707070] font-medium ml-[1.1rem] text-[13px] mt-[10px]'>{item}</li>
                    })
                   }
                   </ul>
            </div>
            ...
            <p className='text-[#707070] font-bold mb-[1rem] ml-[.5rem]'>Help & Support</p>
                   ...
                   {
                    textArr[3].map((item)=>{
                      return <li className=' capitalize text-[#707070] ml-[1.1rem] font-medium text-[13px] mt-[10px]'>{item}</li>
                    })
                   }
                   </ul>
            </div>
            ...
            <p className='text-[#707070] font-bold mb-[1rem] ml-[.5rem]'>More Info</p>
                   ...
                   <button className='bg-[#42C8B7] flex rounded-xl p-[.5rem] mt-[1rem]'>
                    ...
                    <p className='text-white text-start'>
                      ...
                      <p className='font-medium text-[12px] mt-[10px]'>Got questions? Just ask.</p>
                    </p>
                   </button>
            </div>
        </div>
        {/* ****************************************************************** */}
          <div className='flex flex-col gap-[2rem] items-center sm:flex-row sm:border-y-2 py-[1rem]'>
          <div className='pl-[1rem] sm:w-[70%] sm:text-[12px] font-medium'>
