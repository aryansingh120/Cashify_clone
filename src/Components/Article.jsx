...
const Article = () => {
    let articleArr=[{photo:"/photos/hyper5.png",head:"HyperOS 2.0 Eligible Devices, Release Date All Details List!",text:"The HyperOS 2.0 release date will be announced in the first week of October, with the rollout for Hyper OS 2.0 eligible devices starting in the second week.",date:"22nd Sep 2024"},{photo:"/photos/hyper2.webp",head:"Best Airtel, Jio, Vi International Roaming Plans In 2024",text:"If you are searching for the best international roaming plans for Airtel, Jio and Vi, you have landed just at the right place. Find the complete details below.",date:"18th Sep 2024"},{photo:"/photos/hyper3.webp",head:"What Is The New Camera Control Button In iPhone 16?",text:"Are you curious about the new Camera Control Button in the iPhone 16 series? Here is everything you need to know about it before you buy a new iPhone!",date:"16th Sep 2024"}];
